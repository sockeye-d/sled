...
func load_theme(file: String) -> void:
	ThemeImporter.import_theme(file if file else ThemeImporter.last_imported_theme, self, GLSLLanguage.base_types, GLSLLanguage.keywords.keys(), GLSLLanguage.comment_regions, GLSLLanguage.string_regions)
