...
public:
	...
	[[nodiscard]] bool get_skip_whitespace() const;
	void set_skip_whitespace(bool p_skip_whitespace);
	void debug_print() const;
	void tokenize();
	godot::Vector<GLSLToken*> get_partial_tokens();
	godot::Array get_tokens() const;
